...
public class ApplicationController {
    ...
    public List<Application> getMyApplications(Long taUserId) {
    ...
    public List<Job> getAvailableJobs(Long taUserId) {
        List<Job> allJobs = jobService.listPublishedJobs();
        
        List<Application> applications = applicationService.listByTaUserId(taUserId);
    ...
    public boolean submitApplicationWithFeedback(Long taUserId, Long jobId, String statement, Long cvId, JFrame parent) {
        ...
        try {
            Application application = applicationService.submitApplication(taUserId, jobId, statement, cvId);
            JOptionPane.showMessageDialog(parent, 
    ...
    public String getDisplayStatus(Application application) {
        return ApplicationStatus.getDisplayText(application.getStatus());
    }
    
    public String getShortDisplayStatus(Application application) {
        return ApplicationStatus.getShortDisplayText(application.getStatus());
    }
    
    public String getFeedbackMessage(Application application) {
