...
public class RegisterFrame extends JFrame {
    ...
    private void initUI() {
        ...
        roleGroup.add(taTab); roleGroup.add(moTab); roleGroup.add(adminTab);

        // 绑定角色切换事件，更新 selectedRole 并重绘按钮样式
        taTab.addActionListener(e -> { selectedRole = UserRole.TA; updateRoleTabStyles(taTab, moTab, adminTab); });
        moTab.addActionListener(e -> { selectedRole = UserRole.MO; updateRoleTabStyles(taTab, moTab, adminTab); });
        adminTab.addActionListener(e -> { selectedRole = UserRole.ADMIN; updateRoleTabStyles(taTab, moTab, adminTab); });

        rolePanel.add(taTab); rolePanel.add(moTab); rolePanel.add(adminTab);
        ...
        registerBtn.addActionListener(e -> handleRegister()); // 绑定注册逻辑
    ...
    private void handleRegister() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Registration Successful!\nStatus: " + user.getStatus(), "Success", JOptionPane.INFORMATION_MESSAGE);
