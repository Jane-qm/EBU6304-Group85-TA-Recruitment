...
public class TAWorkloadPanel extends JPanel {
    ...
    private JPanel createWorkloadSummary() {
        ...
        List<Application> applications = applicationController.getMyApplications(ta.getUserId());
    ...
    private void refreshContent() {
        ...
        if (hiredApplications.isEmpty()) {
            ...
            for (Application app : hiredApplications) {
    ...
    private JPanel createOfferCard(Application app) {
    ...
    private String getCourseName(Long jobId) {
        List<Job> jobs = applicationController.getPublishedJobs();
        for (Job job : jobs) {
